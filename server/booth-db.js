// Isolated database for the public photobooth ("shm-is-not-present" version).
// Mirrors the schema/helpers of db.js but writes to booth.db so booth captures
// never mix with the main installation's rsp.db.
...
const dbPath = path.join(__dirname, 'booth.db');
...
// Create tables (same shape as db.js, minus questionnaire — booth gallery drops it)
db.exec(`
...
// Full pipeline query (used by the gallery flip-to-capture feature)
